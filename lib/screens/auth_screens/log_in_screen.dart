              ...
              child: Container(
                  ...
                  child: Column(
                    children: [
                              ...
                              Container(
                                ...
                                child: Stack(
                                  ...
                                  children: [
                                    ...
                                    Align(
                                      alignment: Alignment.bottomCenter,
                                      child: Text('Welcome Back'.tr, style: TextStyle(fontWeight: FontWeight.w600,fontSize: 20),),
                                    ),
                                  ],
                                ),
                              ),
                      ...
                      Align(
                        alignment: Alignment.centerLeft,
                        child: Text('Phone No:'.tr, style: TextStyleCustomize.titleSmallGray90006Medium,),
                      ),
                      SizedBox(height: 7.v,),
                      _buildPhone(),
                    ],
